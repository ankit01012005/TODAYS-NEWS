...
/// are typography. The list follows publication order and is presented
/// as a reading sequence rather than a popularity ranking.
export function TopStories({ stories }: { stories: PublicArticleSummary[] }) {
  if (stories.length < 2) return null;

  return (
    <section aria-labelledby="top-heading">
      <SectionHeading id="top-heading" title="The news index" eyebrow="Continue reading" />
